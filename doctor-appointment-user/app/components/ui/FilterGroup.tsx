      ...
      {groupName === "Rating" ? (
        ...
        <div className={styles.radioGroups_container}>
          <RadioItem
            ...
            checked={currentValue === "15+"}
          />
          <RadioItem
            radioName="10-15 years"
            idName="years10"
            name={groupName}
            onChange={() => handleRadioChange("10-15")}
            checked={currentValue === "10-15"}
          />
          <RadioItem
            radioName="5-10 years"
            idName="years5"
            name={groupName}
            onChange={() => handleRadioChange("5-10")}
            checked={currentValue === "5-10"}
          />
          <RadioItem
            radioName="3-5 years"
            idName="years3"
